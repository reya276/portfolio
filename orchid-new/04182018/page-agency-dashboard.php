            ...
            <div id="contactorchid" style="position: absolute;top:40px;left:82.5%;border:1px solid #ccc;width:12%;height:auto;padding:0;box-shadow: 3px 3px #cccccc;z-index:100 !important;">
                <div style="float:left;margin-left:10px;text-align:left;">
                  ...
                  <p class="agenncy">
                      ...
                      <a href="http://orchidinsurance.com/wp-content/themes/orchid-new/assets/pdf/AgencyDashboardGuiderev2.pdf" class="none" style="text-decoration:none;" target="_blank">User's Guide</a>
                  </p>
                </div>
            </div>
<div id="exg-pol">
