...
function getCaribb() {
    ...
    //var caaradiok = "<i class='coast-coastal-logo' aria-hidden='true' style='color:#004eb4;'></i>Coastal Agents Alliance<br/><a href='https://brokers.coastalagentsalliance.com/scripts/RatingWebServer.dll/Login' target='_blank' title='Click here to login to CAA'>Login to Coastal Agents Alliance</a>";
    ...
    //var caaradio = "<i class='coast-coastal-logo' aria-hidden='true' style='color:#004eb4;'></i>Coastal Agents Alliance<br/><a href='https://brokers.coastalagentsalliance.com/scripts/RatingWebServer.dll/Login' target='_blank' title='Click here to login to CAA'>Login to Coastal Agents Alliance</a>";
        ...
        if (initValue == 1) {
            ...
            switch (fstate) {
                case 'Alabama':
                    ...
                    // console.log(initValue + " - " + fstate);
                    window.open("http://connect.orchidinsurance.com", "_blank");
                    break;
                case 'Arizona':
                    document.getElementById("state").innerHTML = fstate;
                    document.getElementById("velocity").innerHTML;
                ...
                case 'Connecticut':
                    ...
                    document.getElementById("velocity").innerHTML;
                    document.getElementById("ModalLabel").innerHTML = "Personal Line Selected - " + initTxt;
                    document.getElementById("providers").innerHTML = ppradio + caaradiok;
                    $("#velocity").modal();
                    //check to see if the default system is checked and show logo
                    if ($('.chkradio').is(':checked')) {
                        return getLogos(1);
            ...
            switch (fstate) {
                case 'Alabama':
                    ...
                    // if($('.chkradio').is(':checked')) { return getLogos(2); }
                    // console.log(initValue + " - " + fstate);
                    window.open("https://connect.orchidinsurance.com/Logon.aspx", "_blank");
                    break;
                case 'Arizona':
                    document.getElementById("state").innerHTML = fstate;
                    document.getElementById("velocity").innerHTML;
...
function defaultLogin(system) {
    if (system == 1) {
        ...
        //Set the form Action
        document.getElementById("modalformA").action = "https://brokers.coastalagentsalliance.com/scripts/CAALogin.dll";
        ...
        document.getElementById("ForgotPA").innerHTML = "[<a href='https://velocity.orchidinsurance.com/policyplus/RetrievePassword'  target='_blank'>Forgot Password</a>]";
...
function getLogos(system, initTxt) {
    ...
    if (system == 1) {
        ...
        // }
        //Set the form Action
        document.getElementById("modalform").action = "https://brokers.coastalagentsalliance.com/scripts/CAALogin.dll";
        ...
        // if (initTxt.indexOf("Residential Condominium Association") > -1){
        //     document.getElementById("usr").innerHTML = "<a href='http://connect.orchidinsurance.com' target='_blank' style='font-weight:bold;'>Click here for Orchid Connect</a>";
        ...
        $("#usr").replaceWith('<p id="demo"></p><div id="caamsgdiva" class="text-left"></div><p id="loginerror" style="color:#a31818;font-weight:bold;"> </p><label for="username">Username:</label><input type="text" class="form-control" id="username" name="username" required placeholder="Enter your username" style="font-family: Helvetica, Arial, sans-serif !important;"/>');
        $("#pwd").replaceWith('<label for="password">Password:</label><input type="password" class="form-control" id="password" name="password" required placeholder="Enter your password" style="font-family: Helvetica, Arial, sans-serif !important;"/>');
        document.getElementById("modalform").action = "https://velocity.orchidinsurance.com/";
